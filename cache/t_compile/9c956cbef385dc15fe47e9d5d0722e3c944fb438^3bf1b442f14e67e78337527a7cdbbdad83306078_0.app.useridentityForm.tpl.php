<?php
/* Smarty version 4.5.5, created on 2026-06-13 11:03:26
  from 'app:useridentityForm.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_6a2d38fea50ab5_99696925',
...
function content_6a2d38fea50ab5_99696925 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
	$(function() {
...
$_block_repeat=true;
echo $_block_plugin1(array('id'=>"userNameInfo"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin2(array('title'=>"user.username"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
echo $_block_plugin2(array('title'=>"user.username"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php $_block_repeat=false;
echo $_block_plugin1(array('id'=>"userNameInfo"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>

	<?php $_block_plugin3 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0] : null;
if (!is_callable($_block_plugin3)) {
throw new SmartyException('block tag \'fbvFormArea\' not callable or registered');
}
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormArea', array('id'=>"userFormCompactLeft"));
$_block_repeat=true;
echo $_block_plugin3(array('id'=>"userFormCompactLeft"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin4(array('title'=>"user.name"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		...
		<?php $_block_repeat=false;
echo $_block_plugin4(array('title'=>"user.name"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php $_block_repeat=false;
echo $_block_plugin3(array('id'=>"userFormCompactLeft"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin5(array('for'=>"preferredPublicName",'description'=>"user.preferredPublicName.description"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
	...
	<?php $_block_repeat=false;
echo $_block_plugin5(array('for'=>"preferredPublicName",'description'=>"user.preferredPublicName.description"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>


	<?php $_block_plugin6 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0] : null;
if (!is_callable($_block_plugin6)) {
throw new SmartyException('block tag \'fbvFormSection\' not callable or registered');
}
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormSection', array('for'=>"preferredAvatarInitials",'description'=>"user.preferredAvatarInitials.description"));
$_block_repeat=true;
echo $_block_plugin6(array('for'=>"preferredAvatarInitials",'description'=>"user.preferredAvatarInitials.description"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"text",'label'=>"user.preferredAvatarInitials",'name'=>"preferredAvatarInitials",'maxlength'=>"2",'id'=>"preferredAvatarInitials",'value'=>$_smarty_tpl->tpl_vars['preferredAvatarInitials']->value,'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['SMALL']),$_smarty_tpl ) );?>

	<?php $_block_repeat=false;
echo $_block_plugin6(array('for'=>"preferredAvatarInitials",'description'=>"user.preferredAvatarInitials.description"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	...
	<div class="orcid_container">
				<?php $_block_plugin7 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0] : null;
...
ob_start();?>
		...
		<?php $_smarty_tpl->_subTemplateRender("app:form/orcidProfile.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
		<?php if ($_smarty_tpl->tpl_vars['orcid']->value && $_smarty_tpl->tpl_vars['orcidAuthenticated']->value) {?>
			<?php $_smarty_tpl->_subTemplateRender("app:linkAction/buttonConfirmationLinkAction.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('modalStyle'=>"negative",'buttonSelector'=>"#deleteOrcidButton",'dialogText'=>"orcid.field.deleteOrcidModal.message"), 0, false);
?>
			<button id="deleteOrcidButton" type="button"  class="pkp_button pkp_button_offset" style="margin-left: 1rem"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>'common.delete'),$_smarty_tpl ) );?>
</button>
		<?php }?>
		<?php $_block_repeat=false;
