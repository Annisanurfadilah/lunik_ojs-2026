...
function content_6a2fe31f53b355_52890913 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
	$(function() {
...
$_block_repeat=true;
echo $_block_plugin1(array('id'=>"customBlocksFormArea",'class'=>"border"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin3(array('label'=>"plugins.generic.customBlock.content",'for'=>"blockContent"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		...
		<?php $_block_repeat=false;
echo $_block_plugin3(array('label'=>"plugins.generic.customBlock.content",'for'=>"blockContent"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin4(array('title'=>"plugins.generic.customBlock.showName",'for'=>"showName",'list'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		...
		<?php $_block_repeat=false;
echo $_block_plugin4(array('title'=>"plugins.generic.customBlock.showName",'for'=>"showName",'list'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php $_block_repeat=false;
echo $_block_plugin1(array('id'=>"customBlocksFormArea",'class'=>"border"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
